 ...
 */
public class AttributeListAdp extends BaseAdapter {
	 ...
	 * Constructor
	 */
	public AttributeListAdp(Context context, Field[] fields,
		...
		this.registerDataSetObserver(new DataSetObserver() {
			...
			public void onChanged() {
				...
				AttributeListAdp.this.items = new AttributeItem[AttributeListAdp.this.editableFieldIndexes.length];
